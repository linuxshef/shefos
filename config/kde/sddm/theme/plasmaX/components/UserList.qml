...
ListView {
    ...
    readonly property int userItemWidth: units.gridUnit  * 11
    readonly property int userItemHeight: units.gridUnit * 11
    ...
    delegate: UserDelegate {
        ...
        avatarPath: model.icon == "file:///usr/share/sddm/faces/.face.icon" ? Qt.resolvedUrl("artwork/user.svg") : model.icon
