...
PlasmaCore.ColorScope {
    ...
    FontLoader {
        ...
        source: config.font === "default" ? Qt.resolvedUrl("components/artwork/font/WeblySleekuil.ttf") : ""        
    }
    ...
    StackView {
        ...
        initialItem: Login {
            ...
            actionItems: [
                ActionButton {
                    iconSource: Qt.resolvedUrl("components/artwork/suspend_primary.svg")//"system-suspend"
                ...
                ActionButton {
                    iconSource: Qt.resolvedUrl("components/artwork/restart_primary.svg")//"system-reboot"
                ...
                ActionButton {
                    iconSource: Qt.resolvedUrl("components/artwork/shutdown_primary.svg")//"system-shutdown"
